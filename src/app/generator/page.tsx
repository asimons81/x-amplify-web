...
import { PostCard } from '@/components/generator/PostCard';
...
import { Loader2, Sparkles, Trash2, Download, Copy, History, Link as LinkIcon, Globe, ChevronDown, Check, Home, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      ...
      <nav className="flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-zinc-500 mb-8">
        ...
        <span className="text-zinc-300">Generator</span>
      </nav>
